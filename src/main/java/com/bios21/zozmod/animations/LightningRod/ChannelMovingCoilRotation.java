...
public class ChannelMovingCoilRotation extends Channel {
    ...
    protected void initializeAllFrames() {
        ...
        frame0.modelRenderersRotations.put("MovingCoil", new Quaternion(0.0F, 0.1305262F, 0.0F, 0.9914449F)); //15
        frame0.modelRenderersTranslations.put("MovingCoil", new Vector3f(0.0F, -16.0F, 2.0F));
        keyFrames.put(0, frame0);

        KeyFrame frame1 = new KeyFrame();
        frame1.modelRenderersRotations.put("MovingCoil", new Quaternion(0.0F, 0.25881904F, 0.0F, 0.9659258F)); //30
        ...
        frame2.modelRenderersRotations.put("MovingCoil", new Quaternion(0.0F, 0.38268346F, 0.0F, 0.9238795F)); //45
        ...
        frame3.modelRenderersRotations.put("MovingCoil", new Quaternion(0.0F, 0.5F, 0.0F, 0.8660254F)); //60
        ...
        frame4.modelRenderersRotations.put("MovingCoil", new Quaternion(0.0F, 0.6087614F, 0.0F, 0.7933533F)); //75
        ...
        frame5.modelRenderersRotations.put("MovingCoil", new Quaternion(0.0F, 0.70710677F, 0.0F, 0.70710677F)); //90
        ...
        frame6.modelRenderersRotations.put("MovingCoil", new Quaternion(0.0F, 0.7933533F, 0.0F, 0.6087614F)); //105
        ...
        frame7.modelRenderersRotations.put("MovingCoil", new Quaternion(0.0F, 0.86602545F, 0.0F, 0.49999997F)); //120
        ...
        frame8.modelRenderersRotations.put("MovingCoil", new Quaternion(0.0F, 0.9238795F, 0.0F, 0.38268343F)); //135
        ...
        frame9.modelRenderersRotations.put("MovingCoil", new Quaternion(0.0F, 0.9659258F, 0.0F, 0.25881907F)); //150
        ...
        frame10.modelRenderersRotations.put("MovingCoil", new Quaternion(0.0F, 0.9914448F, 0.0F, 0.13052624F)); //165
        ...
        frame11.modelRenderersRotations.put("MovingCoil", new Quaternion(0.0F, 1.0F, 0.0F, -4.371139E-8F)); //180
        ...
        frame12.modelRenderersRotations.put("MovingCoil", new Quaternion(0.0F, -0.9914448F, 0.0F, 0.13052624F)); //-165
        ...
        frame13.modelRenderersRotations.put("MovingCoil", new Quaternion(0.0F, -0.9659258F, 0.0F, 0.25881907F)); //-150
        ...
        frame14.modelRenderersRotations.put("MovingCoil", new Quaternion(0.0F, -0.9238795F, 0.0F, 0.38268343F)); //-135
        ...
        frame15.modelRenderersRotations.put("MovingCoil", new Quaternion(0.0F, -0.86602545F, 0.0F, 0.49999997F)); //-120
        ...
        frame16.modelRenderersRotations.put("MovingCoil", new Quaternion(0.0F, -0.7933533F, 0.0F, 0.6087614F)); //-105
        ...
        frame17.modelRenderersRotations.put("MovingCoil", new Quaternion(0.0F, -0.70710677F, 0.0F, 0.70710677F)); //-90
        ...
        frame18.modelRenderersRotations.put("MovingCoil", new Quaternion(0.0F, -0.6087614F, 0.0F, 0.7933533F)); //-75
        ...
        frame19.modelRenderersRotations.put("MovingCoil", new Quaternion(0.0F, -0.5F, 0.0F, 0.8660254F)); //-60
        ...
        frame20.modelRenderersRotations.put("MovingCoil", new Quaternion(0.0F, -0.38268346F, 0.0F, 0.9238795F)); //-45
        ...
        frame21.modelRenderersRotations.put("MovingCoil", new Quaternion(0.0F, -0.25881904F, 0.0F, 0.9659258F)); //-30
        ...
        frame22.modelRenderersRotations.put("MovingCoil", new Quaternion(0.0F, -0.1305262F, 0.0F, 0.9914449F)); //-15
        ...
        frame23.modelRenderersRotations.put("MovingCoil", new Quaternion(0.0F, 0.0F, 0.0F, 1.0F)); //0
